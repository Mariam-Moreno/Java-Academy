...
public class ValidatorDemo {
    public static void main(String[] args) {
        ...
        Validator<String> maxLen50 = Validator.from(
            s -> s != null && s.length() <= 50, "Maximo 50 caracteres");
        Validator<String> hasAt = Validator.from(
            s -> s != null && s.contains("@"), "Email debe contener @");
        Validator<Integer> minAge = Validator.from(
            a -> a != null && a >= 18, "Edad minima: 18");
        Validator<Integer> maxAge = Validator.from(
            a -> a != null && a <= 120, "Edad maxima: 120");
        ...
        Validator<User> userValidator = user -> {
            ...
            // Corregido: se pasa el entero directamente, ya que ageValidator es Validator<Integer>
