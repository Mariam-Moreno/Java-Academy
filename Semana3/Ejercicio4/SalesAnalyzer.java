...
public class SalesAnalyzer {
    public static void main(String[] args) {
        ...
        byCategory.forEach((cat, sum) ->
            System.out.printf(Locale.US, "  %s: $%,.2f%n", cat, sum));
        ...
        sales.stream()
            ...
            .limit(3)
            .forEach(s -> System.out.printf(Locale.US, "  %s: $%,.2f%n", s.product(), s.amount()));
        ...
        avgByCategory.forEach((cat, avg) ->
            System.out.printf(Locale.US, "  %s: $%,.2f%n", cat, avg));
        ...
        bestPerRegion.forEach((region, sale) ->
            sale.ifPresent(s -> System.out.printf(Locale.US, "  %s: %s ($%,.2f)%n",
